<section class="sessao_atendimento">
    <div class="texto_atendimento">
        ...
        <p>Sabemos que cada pessoa tem necessidades únicas, por isso além dos pedidos feitos diretamente pelo site, também oferecemos um atendimento especial via WhatsApp. Se você passou por um tratamento específico, possui alguma restrição alimentar, é só falar com a gente. Nosso objetivo é garantir sabor, qualidade e cuidado em cada detalhe do seu pedido.</p>
        <p class="pedidos_whatsapp"><strong>Atenção</strong> Pedidos no WhatsApp são feitos somente em casos de atendimentos personalizados, pois outras ofertas no site, o pedido e todo processo de pagamento é via site.</p>
    </div>
    <!-- Link WhatsApp -->
